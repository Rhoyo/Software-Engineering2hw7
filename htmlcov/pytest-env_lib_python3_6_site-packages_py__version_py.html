...
<head>
    ...
    <title>Coverage for pytest-env/lib/python3.6/site-packages/py/_version.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>pytest-env/lib/python3.6/site-packages/py/_version.py</b> :
